...
export const APPLICATION_QUESTIONS: readonly ApplicationQuestion[] = [
  ...
  { key: "resumeUrl", label: "Share a link to your current resume.", help: "Upload your PDF or Word resume to Google Drive / Dropbox and paste a shareable link. Make sure link-sharing is on. Make sure the link is set to 'Anyone with the link can view' — we can't review private Drive files.", type: "url", required: true, placeholder: "https://drive.google.com/…" },
