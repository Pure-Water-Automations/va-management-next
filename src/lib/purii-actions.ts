...
const READONLY_CTX: McpActor ={ actorId: "", actorEmail: "", actorName: null, actorRole: "HR_MANAGER" as Role, isAdmin: false, vaId: null };
async function taskActorCtx(actorEmail: string): Promise<McpActor> {
  ...
  return { actorId: u.id, actorEmail: u.email, actorName: u.name, actorRole: u.role, isAdmin: u.isAdmin, vaId: u.vaId };
}
