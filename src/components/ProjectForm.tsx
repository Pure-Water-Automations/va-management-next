...
export function ProjectForm({ users, project }: { users: User[]; project?: Project }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Field label="Client">
        <input style={input} value={client} onChange={(e) => setClient(e.target.value)} placeholder="Client name" />
      </Field>
