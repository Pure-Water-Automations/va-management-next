...
// (fixed-width) world. Shows automatically on a user's FIRST visit, then on every
// later visit starts collapsed to a small "❔ Guide" button — so it welcomes
// newcomers once and never gets in the way of returning users (it's always
// reopenable). "Seen" is remembered locally.

const SEEN_KEY = "va-world-help-seen";
...
export function Instructions() {
  ...
  // Mark the guide as seen on first mount, so subsequent visits start collapsed.
  useEffect(() => {
    try {
